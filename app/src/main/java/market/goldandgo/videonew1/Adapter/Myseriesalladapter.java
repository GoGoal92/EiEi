...
public class Myseriesalladapter extends HFRecyclerView<get> {


    ArrayList<get> list;
    Activity ac;
    seriesItemClickListener  ItemClickListener;


    public Myseriesalladapter(Activity getactivity, ArrayList<get> asklist1, seriesItemClickListener ItemClickListener1) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int i) {
        if (holder instanceof ItemViewHolder) {
            ...
            final String fpath = Constant.datalocation_scover +"s"+ list.get(i).getMid() + ".fmovie";
                        ...
                        Picasso.with(ac)
                                ...
                                .into(holder1.fakeiv, new Callback() {
                                    ...
                                    public void onSuccess() {
                                        ...
                                        holder1.iv.setBackground(holder1.fakeiv.getDrawable());
                                        if (!ff.exists()){
                                            Constant.Savetosdcard(ac,list.get(i).getImage(),"s"+list.get(i).getMid(),"s");
                                        }
