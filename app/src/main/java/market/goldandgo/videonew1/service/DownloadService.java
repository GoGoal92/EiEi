...
public class DownloadService extends Service {
    ...
    public static class DownloadCallBack implements CallBack {
        ...
        public void onProgress(long finished, long total, int progress) {
            ...
            mAppInfo.setDownloadPerSize(Constant.getDownloadPerSize(finished, total));
        ...
        public void onCompleted() {
            ...
            Mydatabase_down mdb=new Mydatabase_down(con);
            mdb.update_complete(mAppInfo.getId());
            L.i(TAG, "onCompleted()");
    ...
    public void onCreate() {
        ...
        mDownloadDir = new File(Constant.downloadfolder);
    }
