...
import market.goldandgo.videonew1.Adapter.Myseriesalladapter;
...
import market.goldandgo.videonew1.Utils.seriesItemClickListener;
...
public class Fragment_series extends Fragment implements seriesItemClickListener {
    ...
    public void onResume() {
        ...
        try {
            if (clist.size() < 1) {
                ...
                MyRequest.getcategory_series();

            } else {
                Log.e("con", "2");
                MyRequest.getseeallseries(count + "", cate, reloadd);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                MyRequest.getseeallseries(count + "", cate, "a");
            }
        });
     ...
     /*   cate_lv.setAdapter(ca_adapter);
        ...
        adapter = new Myseriesalladapter(ac, list, this);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!shownet_footer && !show_end_result) {
                    ...
                    if (pastVisibleItems + visibleItemCount >= totalItemCount) {
                        ...
                        MyRequest.getmoreseries(count + "", cate);
                    }
                }
    ...
    private void CustomDialog() {
        ...
        dialogview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                cate = clist.get(position).getMid();
                MyRequest.getseeallseries(count + "", cate, "cate");
                rv.setVisibility(View.GONE);
                pg.setVisibility(View.VISIBLE);
                pg.show();
    ...
    public static void Cate_Feedback(String s) {
        ...
        MyRequest.getseeallseries(count + "", cate, "b");
    }
    ...
    public static void Feedback(String s, String a) {
        ...
        if (a.equals("cate")){
            adapter = new Myseriesalladapter(ac, list, clickthis);
            rv.setAdapter(adapter);
        }else{
