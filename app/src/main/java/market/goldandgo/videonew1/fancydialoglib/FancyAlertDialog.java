...
public class FancyAlertDialog {
    ...
    public static class Builder{
        ...
        public Builder isCancellable(boolean cancel,boolean twobtn){
            this.cancel=cancel;
            this.twobtn=twobtn;
            return this;
        }
        ...
        public FancyAlertDialog build(){
            ...
            onlybtn=(Button)dialog.findViewById(R.id.positiveBtnhide);
            twolayout= (LinearLayout) dialog.findViewById(R.id.twolayout);
            ...
            onlybtn.setText(positiveBtnText);


            if(pBtnColor!=0)
            { GradientDrawable bgShape = (GradientDrawable)onlybtn.getBackground();
